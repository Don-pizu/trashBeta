...
exports.reportCreated = (trackingId) => ({
  email: {
    subject: `Trash Report Submitted   <p>Your report <b>${trackingId}</b> has been received.</p>`,
...
exports.reportAssigned = (trackingId) => ({
  email: {
    subject: `New Task Assigned <p>You have been assigned report <b>${trackingId}</b>.</p>`,
...
exports.reportCompleted = (trackingId) => ({
  email: {
    subject: `Trash Report Completed <p>Your report <b>${trackingId}</b> has been completed.</p>`,
